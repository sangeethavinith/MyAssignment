...
public static void main(String[] args) {
	...
	driver.findElement(By.linkText("DuplicteLead")).click();
	driver.findElement(By.id("createLeadForm_companyName")).clear();
    driver.findElement(By.id("createLeadForm_companyName")).sendKeys("Test Leaf2");
    driver.findElement(By.id("createLeadForm_lastName")).clear();
    driver.findElement(By.id("createLeadForm_lastmentName")).sendKeys("arun");
    driver.findElement(By.className("smallSubmit")).click();
